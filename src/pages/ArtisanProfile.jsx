...
const ArtisanProfile = () => {
  ...
  const artisan = useSelector((state) => 
    state.artisans.items.find((item) => item.id === parseInt(id))
  );
    ...
    <div className="bg-white">
      <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-2 lg:gap-x-8 lg:items-start">
          {/* Artisan Info */}
          <div>
            <h1 className="text-3xl font-extrabold tracking-tight text-gray-900">{artisan.name}</h1>
            <div className="mt-3">
              <p className="text-3xl text-gray-900">{artisan.location}</p>
            </div>
            <div className="mt-6">
              ...
              <div className="text-base text-gray-700 space-y-6">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm text-gray-500">{artisan.specialties}</p>
                </div>
                <div>
                  <h4 className="text-sm font-medium text-gray-900">Experience</h4>
                  <p className="mt-2 text-sm text-gray-500">{artisan.experience}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-10 px-4 sm:px-0 sm:mt-16 lg:mt-0">
            <h2 className="text-2xl font-extrabold text-gray-900">Products by {artisan.name}</h2>
